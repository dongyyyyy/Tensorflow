...
def main():
  ...
  #테스트셋 파일읽음
  test_csv_x_data = np.loadtxt('./airplane_data/testset_x.csv', unpack=True, delimiter=',', skiprows=1)
  test_csv_y_data = np.loadtxt('./airplane_data/testset_y.csv', unpack=True, delimiter=',', skiprows=1)
